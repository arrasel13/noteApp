    ...
    <main>
        <div class="mx-auto max-w-3xl py-6 sm:px-6 lg:px-8">
            <form method="POST" action="/note/edit">
                ...
                <input type="hidden" name="updateid" value="<?= $note['id'] ?>">
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <textarea id="notebody" name="notebody" rows="8" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" placeholder="Note body content here..."><?= $note['body']; ?></textarea>
                                </div>
