...
<main class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
        ...
        <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Un-Authorized</h1>
        <p class="mt-6 text-base leading-7 text-gray-600">Sorry, you are not authorize to preview this.</p>
